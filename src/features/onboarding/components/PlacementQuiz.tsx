...
const quizQuestions: Question[] = [
  // Lesson 1: Introduction to Investing
  {
    ...
    options: [
      { id: "a", text: "To grow wealth over time by earning returns that outpace inflation", isCorrect: true },
      { id: "b", text: "To avoid paying taxes on your income", isCorrect: false },
  ...
  // Lesson 2: Risk vs Reward
  {
    ...
    options: [
      ...
      { id: "b", text: "Both will produce identical results over 25 years", isCorrect: false },
      { id: "c", text: "Investment B likely builds more wealth over time despite short-term volatility", isCorrect: true },
  ...
  // Lesson 3: Compound Interest
  {
    ...
    options: [
      ...
      { id: "b", text: "It only works for people with very large initial investments", isCorrect: false },
      { id: "c", text: "It was discovered alongside other ancient wonders", isCorrect: false },
      { id: "d", text: "Your earnings generate their own earnings, creating exponential growth", isCorrect: true },
    ],
  ...
  // Lesson 6: Market Psychology
  {
    ...
    options: [
      ...
      { id: "b", text: "They immediately buy real estate instead", isCorrect: false },
      { id: "c", text: "They correctly time the market bottom and buy more", isCorrect: false },
      { id: "d", text: "They panic sell at the bottom, locking in losses and missing the recovery", isCorrect: true },
    ],
  ...
  // Lesson 8: Fundamental Analysis
  {
    ...
    options: [
      ...
      { id: "b", text: "How many times the CEO appears on television", isCorrect: false },
      { id: "c", text: "Revenue growth, profit margins, debt-to-equity ratio, and cash flow", isCorrect: true },
  ...
  // Lesson 10: Portfolio Management
  {
    ...
    options: [
      ...
      { id: "b", text: "To eliminate all stocks and move to cash", isCorrect: false },
      { id: "c", text: "To restore your target allocation by selling some of the winner and buying underweighted assets", isCorrect: true },
  ...
  // Lesson 15: Options Trading
  {
    ...
    options: [
      ...
      { id: "b", text: "Collect dividend payments from any stock", isCorrect: false },
      { id: "c", text: "Buy shares at a specific price before expiration", isCorrect: true },
  ...
  // Lesson 17: Bonds and Fixed Income
  {
    ...
    options: [
      { id: "a", text: "Bond prices fall because new bonds offer more attractive yields", isCorrect: true },
      { id: "b", text: "Bond prices rise because higher rates are better for bondholders", isCorrect: false },
